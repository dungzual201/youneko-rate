...
class StreamingSpectrogramAccumulator(
    ...
    private val sourceMime: String? = null,
    private val codecDetectionSource: String? = null,
    private val rawHeaderHex: String? = null,
    private val channels: Int = 1,
    private val bitDepth: Int? = null,
    private val bitrate: Long? = null,
    private val bitrateNote: String? = null,
    private val theoreticalBitrate: Long? = null,
) {
    ...
    val metadata: SpectrogramMetadata = SpectrogramMetadata(
        ...
        codecDetectionSource = codecDetectionSource,
        rawHeaderHex = rawHeaderHex,
        channels = channels,
        bitDepth = bitDepth,
        bitrate = bitrate,
