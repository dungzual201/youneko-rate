...
const val CURRENT_BACKUP_SCHEMA = 13
...
data class TrackSnapshot(
    val id: String, val albumId: String?, val title: String, val trackNumber: Int?, val discNumber: Int?, val durationMs: Long?, val isStandalone: Boolean, val stars: Double?, val reviewText: String?, val isSkip: Boolean, val isHighlight: Boolean, val listenedDate: String?, val recordingMbid: String?, val workMbid: String?, val isrc: String?, val sourceUri: String?, val fileName: String?, val createdAt: Long, val updatedAt: Long,
)
...
private fun TrackEntity.toSnapshot() = TrackSnapshot(id, albumId, title, trackNumber, discNumber, durationMs, isStandalone, stars, reviewText, isSkip, isHighlight, listenedDate, recordingMbid, workMbid, isrc, sourceUri, fileName, createdAt, updatedAt)
