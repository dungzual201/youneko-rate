...
Sandbox không có emulator hoặc `adb`, nên không thể lấy stack trace logcat thực tế hay chụp screenshot thiết bị. Các hotfix A được kiểm tra bằng code review, unit test WorkManager payload/grouping/dedupe và compile/test Gradle thành công; CI run 32102023444 đã xác nhận assemble debug APK và unit tests PASS. Không có screenshot giả được tạo.
