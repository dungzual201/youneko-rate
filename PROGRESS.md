...
Sandbox không có emulator hoặc `adb`, nên không thể thực hiện kiểm thử tay 8 trường hợp, cài APK, hoặc chụp screenshot kết quả tìm kiếm online, lỗi máy bay, Credits có dữ liệu và Credits không có dữ liệu. Các thay đổi Phase 6 được kiểm tra bằng unit tests fixture/parser/role mapping/dedupe/cache TTL, full `assembleDebug`, `testDebugUnitTest` và `lintDebug` PASS. Không tạo screenshot giả; người dùng phải xác minh trên thiết bị thật sau khi cài APK.
