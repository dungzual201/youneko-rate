...
| 2. Rate & Review: nhập thủ công, chấm sao, tính trung bình, local search/sort/filter | DONE | `43d2cc2` + working tree | 2026-08-18 | Hotfix cascade đã đổi Album/Track/Artist từ REPLACE sang insert/update ABORT; Favorite đã gỡ hoàn toàn bằng migration Room 2→3; UI polish gồm palette mặc định, 5 sao half-fill, tooltip highlight/skip và mascot vector tạm. Regression migration test thêm; local compile/unit tests PASS. Commit refactor sẽ được push cùng Phase 3 commit sau final verification. |
| 3. Import metadata từ tag file nhạc local | IN-PROGRESS | Chưa có | 2026-08-18 | Đã triển khai SAF file/multiple/folder, jaudiotagger 3.0.1, preview selection, group nhiều disc/bài lẻ, dedupe merge không destructive, embedded/custom cover và WorkManager progress/cancel. Unit suite 16 tests PASS; clean assembleDebug và compile AndroidTest PASS. Chờ commit/push/CI trước khi chuyển DONE. |
