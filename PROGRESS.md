...
| 2. Rate & Review: nhập thủ công, chấm sao, tính trung bình, local search/sort/filter | IN-PROGRESS | Chưa commit hotfix | 2026-08-18 | Đã hoàn tất hotfix main-thread navigation cho tạo/xoá album bằng Channel one-shot events + LaunchedEffect; thêm AlbumRepository/SettingsStore interfaces, null-safe AlbumDetailUiState và regression tests. Local `testDebugUnitTest` PASS 12 tests; `compileDebugAndroidTestKotlin` PASS. Đang chờ clean build, commit/push và CI xanh; chưa làm phase 3. |
