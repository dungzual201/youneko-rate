...
| 3. Import metadata từ tag file nhạc local | DONE | `0589742` | 2026-08-18 | SAF hỗ trợ một/nhiều file và folder; jaudiotagger 3.0.1; preview selection; group nhiều disc/bài lẻ; dedupe merge không destructive; embedded/custom cover; WorkManager progress/cancel. 16 unit tests PASS; `clean assembleDebug`, `testDebugUnitTest`, `compileDebugAndroidTestKotlin` PASS. CI [Android Build #32094492606](https://github.com/dungzual201/youneko-rate/actions/runs/32094492606) PASS với assembleDebug, unit tests và upload artifact. |
