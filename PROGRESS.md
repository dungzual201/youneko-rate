...
| 7. Provider phụ và quản lý nguồn/token/cache | IN-PROGRESS | `27ca8d6` | 2026-08-18 | Discogs API/service đã triển khai: mặc định tắt, token DataStore, cache 30 ngày, client/rate limiter riêng 25 req/phút, merge credit/source chip và clear cache UI. Last.fm toggle/key có UI; Last.fm/Deezer/ListenBrainz service còn TODO. CI [#32139923234](https://github.com/dungzual201/youneko-rate/actions/runs/32139923234) PASS. |
| 8. Audio Quality Checker phần 1: decode, FFT, spectrogram, technical info | IN-PROGRESS | `6b6f18d` | 2026-08-18 | Đã triển khai MediaExtractor/MediaCodec decode-only, ba đoạn 30 giây, FFT 4096 Hann/hop 2048, cutoff/rolloff/crest factor/true peak/clipping, heuristic verdict, spectrum JSON, foreground WorkManager, file picker và Analyze Canvas. Cần test matrix thiết bị thật; chưa có spectrogram PNG export đầy đủ. CI [#32139923234](https://github.com/dungzual201/youneko-rate/actions/runs/32139923234) PASS. |
...
Sandbox không có emulator hoặc `adb` (`adb-not-installed`), nên không thể thực hiện logcat thực tế, kiểm thử tay, cài APK, xác minh dialog không bị bottom navigation che, decoder MediaCodec trên codec matrix, hoặc chụp ảnh. Không đoán thay cho bằng chứng. Sau parser/Discogs/Phase8 v1, local `assembleDebug`, `testDebugUnitTest` và `lintDebug` đều PASS ngày 2026-08-18; `AudioAnalysisTest` và `PlaybackCapabilityGuardTest` PASS. CI [#32139923234](https://github.com/dungzual201/youneko-rate/actions/runs/32139923234) PASS trên SHA `137939d`. Chưa có APK mới và chưa có ảnh chụp thật; không báo hoàn thành sản phẩm cho đến khi người dùng xác minh trên thiết bị.
